 ...
 */
contract Token is Context, ERC165, IERC721, WhitelistedRole {
    ...
    function displayAnimals(address _address, uint number) public view returns (uint)  {
    return (_animalsOfOwner[_address][number].id);
}
